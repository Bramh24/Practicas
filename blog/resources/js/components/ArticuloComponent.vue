                            ...
                            <tbody>
                                <tr v-for="articulo in arrayArticulo" :key="articulo.id">
                                    <td>
                                        ...
                                        <template v-else>
                                            <button type="button" class="btn btn-info btn-sm" @click="activarArticulo(articulo.id)"> <i class="icon-check"></i> </button>
                                        </template>
                                    </td>
        ...
        methods : {
                ...
                swal.fire({
                    ...
                    if(result.value){
                        ...
                        axios.put('/articulo/desactivar',{
                            ...
                            swal.fire(
                                'Desactivado!',
                                'El registro ha sido desactivado con éxito.', 'success'
                                )
                        }).catch(function (error){
                            console.log(error);
                        });
            ...
            validarArticulo(){
                ...
                if(!this.precio_venta)
                    this.errorMostrarMsjArticulo.push("El precio venta del artículo debe ser número y no puede estar vacío.");
